...
public class PickPocket : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        numcoins = Random.Range(1, (int)Events.GetPlayer().iteminv.Coins()/2);

            Events.GetPlayer().iteminv.SubstractCoins(numcoins);

        text.text = "some boy PICKPOCKETED\n" + numcoins + " coins from you!";
    }
